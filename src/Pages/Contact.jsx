      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row  lg:flex-row  gap-20">
        ...
        <div className="w-full md:w-1/2">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-textcolor text-white py-3 rounded uppercase tracking-wide hover:bg-hovertextcolor"
            >
              Send
            </button>
          </form>
        ...
        <div className="w-full md:w-1/2 space-y-10">
          <h3 className="text-lg  text-gray-800 font-merriweather">SNSKCNSK ?</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg text-gray-800 font-merriweather">Al Noor ul Huda Institute International</h3>
            <p className="text-gray-600 font-playfair lg:text-xl">address</p>
            <p className="text-gray-600 font-playfair lg:text-xl">03 xxxxx</p>
            <p className="text-gray-600 font-playfair lg:text-xl">xxxxxx@gmail.com</p>
          </div>
          <div>
           <button
          //  onClick={()=>window.open("https://maps.app.goo.gl/gUNXSAR4cvZfFoJz7","_blank")}
              className="w-44 bg-textcolor text-white py-3 rounded uppercase tracking-wide hover:bg-hovertextcolor"
            >
              GET Direction
            </button>
          </div>
